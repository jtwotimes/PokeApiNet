...
namespace PokeApiNet.Cache
{
        ...
        where TExpirableCache : BaseExpirableCache
    {
        ...
        public BaseCacheManager()
        {
            ...
            this.resourceTypeToCache = ResourceTypes.ToDictionary(x => x, _ => this.CreateCacheForResource());
        }
        ...
        protected abstract TExpirableCache CreateCacheForResource();
